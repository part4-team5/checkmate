	...
	return (
		<AnimatePresence>
			<div className="fixed inset-0 z-50" onClick={handleButtonClick}>
				<motion.div
					className="fixed bottom-0 h-[calc(100vh-60px)] w-full overflow-y-auto bg-background-secondary pb-72 shadow-teamTaskList scrollbar:w-2 scrollbar:bg-background-primary scrollbar-thumb:bg-background-tertiary tablet:right-0 tablet:w-[55%] desktop:w-[45%]"

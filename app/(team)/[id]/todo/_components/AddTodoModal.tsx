				...
				>
					<div className="mx-auto flex w-full max-w-80 flex-col tablet:min-w-80">
						...
						>
							<button
								type="button"
								className="bg-todo-primary flex h-[50px] w-full min-w-[110px] items-center justify-between rounded-xl border border-border-primary px-3 text-lg font-medium text-text-default shadow-buttonPrimary"
							>
